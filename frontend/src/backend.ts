...
import type { Appointment as _Appointment, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAppointmentsByEmail(arg0: string): Promise<Array<Appointment> | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_Appointment>]): Array<Appointment> | null {
